...
export const PandaSchema = z.object({
  pandapuid: z.number().positive().optional().describe('普系号').default(0),
  ...
  father_id: z.number().positive().optional().describe('父亲ID').default(0),
  mother_id: z.number().positive().optional().describe('母亲ID').default(0),
